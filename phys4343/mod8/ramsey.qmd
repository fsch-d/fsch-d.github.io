...
```{python}
#| fig-align: center
#| fig-alt: "Bloch-sphere diagram showing the effect of the first pi-over-two pulse. The initial Bloch vector points downward at the south pole. A rotation around the negative u-axis moves the vector into the equatorial plane, ending at the negative v direction. The diagram includes the Rabi vector, trajectory arcs, and labeled axes u, v, and w."
import numpy as np
