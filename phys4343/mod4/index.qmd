---
title: "Hydrogen Atom: Shifts and Interactions"
...
As we have seen in the [Hydrogen (Wave Functions)](../mod3/hydrogen.qmd) chapter, the Schrödinger picture gives a remarkably simple description of the hydrogen atom. The energy levels depend only on the principal quantum number $n$:
...
- **[Summary of Energy Shifts](./summary.qmd)** — an overview of the level structure and how each correction modifies the spectrum, illustrated step by step.  
- **[Atoms in External Fields](./fields.qmd)** — the response of hydrogen to static magnetic and electric fields (Zeeman and Stark effects), showing additional characteristic splittings and shifts.  
