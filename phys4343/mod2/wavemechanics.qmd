...
<!-- A Python double-slit animation can be inserted here later.
     Useful quantities to visualize: path difference, relative phase,
     wave amplitudes, and the resulting intensity/probability pattern.
-->
