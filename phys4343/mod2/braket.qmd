...
The abstract state $\ket{\psi}$ can be represented in different bases.
...
If the system is in the normalized state $\ket{\psi}$, the probability of obtaining the eigenvalue $a_n$ is
