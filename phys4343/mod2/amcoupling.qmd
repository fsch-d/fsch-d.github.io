...
def draw_vector(r, v, color, label):
    ...
    ax.text(r[0]+v[0]*1.1, r[1]+v[1]*1.1, r[2]+v[2]*1.1, label, color=color, fontsize=8)
...
ax.text(0.2, 0, 4, s=f'$z$', ha='right', color='k', fontsize=8)
...
for m in m_arr:
    ...
    ax.text(0.2, 0, J[2]-0.1, s=f'${m} \hbar$', ha='right', color='k', fontsize=7)
...
fig.subplots_adjust(
    ...
    bottom=0.35, # Reduce bottom margin (adjust as needed)
    top=0.65     # Reduce top margin (adjust as needed)
)
plt.show()
```
