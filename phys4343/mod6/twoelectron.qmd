...
```{python}
#| fig-cap: Simplified Grotrian diagram for helium, showing the dipole-allowed transitions within the singlet (parahelium) and triplet (orthohelium) systems. Cross-system transitions are spin-forbidden.
#| fig-alt: Simplified Grotrian diagram for helium, showing the dipole-allowed transitions within the singlet (parahelium) and triplet (orthohelium) systems. Cross-system transitions are spin-forbidden. 
